...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor>{
    ...
    // ************************
    // *
    // * DO NOT FORGET TO RUN THIS APPLICATION THROUGH AN IMAGE BASED ON GOOGLE API 19 (assuming you are using an emulator)
    // *
    // ************************

    // GCM variables for push
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (checkPlayServices()) {
            ...
            Log.w("GOOGLE_PLAY_SERVICES", "This device has Google Play Services");
        } else {
            Log.w("GOOGLE_PLAY_SERVICES", "This device does not have Google Play Services");
        }
    }
